...
public class GetUserPaginatedQueryHandler : IRequestHandler<GetUserPaginatedQuery, BaseResponse>, IGetPaginated<UserPaginatedEntity> {
    
    private readonly AppRepository Repository;
    private readonly IMapper Mapper;

    public GetUserPaginatedQueryHandler(AppRepository repository, IMapper mapper) {
        Repository = repository;
        Mapper = mapper;
    }

    public async Task<BaseResponse> Handle(GetUserPaginatedQuery request, CancellationToken cancellationToken) {
